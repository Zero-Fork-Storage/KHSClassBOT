...
class INFO(commands.Cog):
    ...
    async def help(self, ctx: Context):
        ...
        embed.add_field(name="/about", value="Introduce of Pachirisu", inline=False)
        embed.add_field(
            name="/수능", value="2022학년도 대학수학능력시험 d-day counter", inline=False
        )
        embed.add_field(name="/조식", value="오늘 조식 메뉴", inline=True)
        embed.add_field(name="/중식", value="오늘 중식 메뉴", inline=True)
        embed.add_field(name="/석식", value="오늘 석식 메뉴", inline=True)
    ...
    async def about(self, ctx: SlashContext):
        """!about"""
        embed = discord.Embed(color=0x60F6C4)
        embed.set_author(
            name="Pachirisu", url="https://github.com/zeroday0619/KHSClassBOT"
        )
        embed.add_field(
            name="About...",
